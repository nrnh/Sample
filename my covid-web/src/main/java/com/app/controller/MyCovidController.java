...
public class MyCovidController {
	...
	/*
	 * @GetMapping(MINING_MY_COVID) String mining() throws Exception {
	 * log.info("mining() started"); String strReturn = null;
	 * 
	 * try { covidMiningAPITotalCases.doMining(); strReturn =
	 * covidMiningAPITotalCases.getTotalfromDB(); } catch (Exception e) { // TODO
	 * Auto-generated catch block log.error("mining() exception " + e.getMessage());
	 * throw new Exception(e); }
	 * 
	 * log.info(MINING_MY_COVID + " return = {}" + strReturn); return strReturn; }
	 */
	...
	// The method below accepting parameter 
